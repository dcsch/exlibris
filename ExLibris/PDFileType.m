...
+ (NSDictionary *)fileTypeDictionary {
  ...
  if (!fileTypes) {
    NSURL *url = [[NSBundle mainBundle] URLForResource:@"FileTypes"
                                         withExtension:@"plist"];
    ...
    for (NSDictionary *item in plist) {
      ...
      fileTypes[key] = [PDFileType fileTypeWithId:type
                                             name:item[@"Name"]
    ...
    //        fileTypes[[NSNumber numberWithUnsignedInteger:TEXT_FILE_TYPE_ID]]
    //        = [PDFileType fileTypeWithId:TEXT_FILE_TYPE_ID
    //                                                   name:@"TXT"
    //                                            detail:@"ASCII text file"];
    //        fileTypes[[NSNumber
    //        numberWithUnsignedInteger:BINARY_FILE_TYPE_ID]] = [PDFileType
    //        fileTypeWithId:BINARY_FILE_TYPE_ID
    //                                                   name:@"BIN"
    //                                            detail:@"General binary
    //                                            file"];
    //        fileTypes[@0x08U] = [PDFileType fileTypeWithId:0x08
    //                                            detail:@"Graphics screen
    //                                            file"];
    //        fileTypes[[NSNumber
    //        numberWithUnsignedInteger:DIRECTORY_FILE_TYPE_ID]] = [PDFileType
    //        fileTypeWithId:DIRECTORY_FILE_TYPE_ID
    //                                                   name:@"DIR"
    //                                            detail:@"Directory file"];
    //        fileTypes[@0x18U] = [PDFileType fileTypeWithId:0x18
    //                                            detail:@"AppleWorks Data Base
    //                                            file"];
    //        fileTypes[@0x19U] = [PDFileType fileTypeWithId:0x19
    //                                            detail:@"AppleWorks Word
    //                                            Processor file"];
    ...
    //                                            detail:@"ProDOS CI added
    //                                            command file"];
    //        fileTypes[@0xf1U] = [PDFileType fileTypeWithId:0xf1
    //                                            detail:@"ProDOS user defined
    //                                            file 1"];
    ...
    //                                            file 8"];
    //        fileTypes[[NSNumber
    //        numberWithUnsignedInteger:INTEGER_BASIC_FILE_TYPE_ID]] =
    //        [PDFileType fileTypeWithId:INTEGER_BASIC_FILE_TYPE_ID
    //                                            detail:@"Integer BASIC program
    //                                            file"];
    //        fileTypes[@0xfbU] = [PDFileType fileTypeWithId:0xfb
    //                                            detail:@"Integer BASIC
    //                                            variable file"];
    //        fileTypes[[NSNumber
    //        numberWithUnsignedInteger:APPLESOFT_BASIC_FILE_TYPE_ID]] =
    //        [PDFileType fileTypeWithId:APPLESOFT_BASIC_FILE_TYPE_ID
    //                                                   name:@"BAS"
    //                                            detail:@"Applesoft program
    //                                            file"];
    //        fileTypes[@0xfdU] = [PDFileType fileTypeWithId:0xfd
    //                                                   name:@"VAR"
    //                                            detail:@"Applesoft variables
    //                                            file"];
    //        fileTypes[@0xfeU] = [PDFileType fileTypeWithId:0xfe
    //                                                   name:@"REL"
    //                                            detail:@"Relocatable code file
    //                                            (EDASM)"];
    //        fileTypes[[NSNumber
    //        numberWithUnsignedInteger:SYSTEM_FILE_TYPE_ID]] = [PDFileType
    //        fileTypeWithId:SYSTEM_FILE_TYPE_ID
    //                                                   name:@"SYS"
...
{ return [[PDFileType alloc] initWithId:aTypeId name:aName detail:adetail]; }

+ (PDFileType *)fileTypeWithId:(NSUInteger)aTypeId detail:(NSString *)adetail;
{ return [[PDFileType alloc] initWithId:aTypeId detail:adetail]; }
...
- (instancetype)initWithId:(NSUInteger)aTypeId detail:(NSString *)adetail;
{
...
- (NSString *)description {
  if (name)
    return
        [NSString stringWithFormat:@"%@ ($%02lX)", name, (unsigned long)typeId];
  else
